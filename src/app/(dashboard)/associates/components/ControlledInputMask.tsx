        ...
        <div className="w-full flex flex-col gap-1.5">
          ...
          <div className="relative">
            <InputMask
              ...
              replacement={{ "_": /\d/ }}
              className={cn(
                "block w-full border rounded-md px-3 py-2 h-[46px] focus:outline-none focus:ring-2 pr-10",
                error
            ...
            {loading && (
              <Loader2
                className="absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5 animate-spin text-gray-400"
              />
            )}
          </div>
          {error && (
