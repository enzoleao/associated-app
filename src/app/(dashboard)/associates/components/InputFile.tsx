...
export function InputFile() {
  ...
  return (
    <div className="relative flex items-center justify-center gap-3 rounded-full h-[96px] w-[96px] bg-gray-100 border-2 border-dashed hover:bg-gray-200 hover:border-blue-500 transition-all cursor-pointer">
