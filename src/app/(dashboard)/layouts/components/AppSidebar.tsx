...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const { data: tenantInformationsData, isLoading: isLoadingTenantInformations } =
    useTenantInformations(tenantId || "")
  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      ...
      <SidebarContent className="pt-4">
        {isLoadingTenantInformations || !menuData || !Array.isArray(menuData) ? (
          <div className="flex flex-col gap-2 px-2">
            {fallbackNav.map((_, idx) => (
